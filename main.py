...
parser.add_argument('--epochs', default=30, type=int, required=False, help='(default=%(default)d)')
...
def main():
    ...
    print('=' * 100)
    dataset_list={'data_path': '/home/dhc4003/cctv_yolo/data_list/', 'train_list_path': '/home/dhc4003/cctv_yolo/data_list/foottraffic/FOOTTRAFFIC_train_list.txt', 'val_list_path': '/home/dhc4003/cctv_yolo/data_list/foottraffic/FOOTTRAFFIC_test_list.txt'}
    # Data loading code
